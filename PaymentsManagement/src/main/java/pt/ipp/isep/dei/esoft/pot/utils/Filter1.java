...
public final class Filter1 {
    ...
    public Filter1(String arg) {

        this.rTrans = AplicacaoPOT.getInstance().getPlataforma().getRegisterTransaction();
        this.lstTrans =rTrans.getListTransactioByOrg(arg);

        
        for (Transaction lstTran : lstTrans) {
            System.out.println(lstTran);
    ...
    public Filter1(Freelancer freel, String arg) {
