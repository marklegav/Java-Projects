 ...
 */
public class PerformanceIndicators_Payment_UI implements Initializable {
    ...
    private void btnDelay(ActionEvent event) {
        try {
            PerformanceIndicators_Delay_UI payUI = (PerformanceIndicators_Delay_UI) this.mainApp.replaceSceneContent("/fxml/PerformanceIndicator_Delay.fxml");
            ...
            try {
                ...
                Logger.getLogger(PerformanceIndicators_Payment_UI.class.getName()).log(Level.SEVERE, null, ex1);
            }
