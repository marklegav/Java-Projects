 ...
 */
public class PerformanceIndicators_Delay_UI implements Initializable {
    ...
    @FXML
    private void btnNDistribution(ActionEvent event) throws Exception {
        
        try {
            MainUI main = (MainUI) this.mainApp.replaceSceneContent("/fxml/PerformanceIndicators_NDistribution.fxml");
    ...
    private void btnPayment(ActionEvent event) throws Exception {
        try {
            PerformanceIndicators_Payment_UI payUI = 
                    (PerformanceIndicators_Payment_UI) this.mainApp.replaceSceneContent("/fxml/AdmFreelancerStatistics_Payment.fxml");
